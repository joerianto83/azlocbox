@{
    ...
    # SDN Lab Domain
    SDNDomainFQDN                        = "rapidbox.local"                      # Limit name (not the .com) to 14 characters as the name will be used as the NetBIOS name.
    DCName                               = "rapidboxDC"                          # Name of the domain controller virtual machine (limit to 14 characters)
